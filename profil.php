<?php
    ...
    $uid = $_SESSION["u_id"];
    $last = 'SELECT user_last FROM tbl_benutzer WHERE user_uid=' . $uid . '';
    $first = 'SELECT user_first FROM tbl_benutzer WHERE user_uid=' . $uid . '';

    $sql = "SELECT user_last, user_first, user_firm, user_pic FROM tbl_benutzer";
    $result = $db->query($sql);
